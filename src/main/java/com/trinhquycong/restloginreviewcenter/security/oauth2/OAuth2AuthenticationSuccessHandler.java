...
import com.trinhquycong.restloginreviewcenter.config.AppProperties;
import com.trinhquycong.restloginreviewcenter.exception.BadRequestException;
import com.trinhquycong.restloginreviewcenter.security.jwt.TokenProvider;
import com.trinhquycong.restloginreviewcenter.util.CookieUtils;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
    	// lỗi ở đoạn REDIRECT_URI_PARAM_COOKIE_NAME
